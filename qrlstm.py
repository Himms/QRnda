...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 13 09:53:25 2024
...
print("Precision of the LSTM :\t"+str(precision_score(test_integer_labels, predicted_labels)))
print("Recall of the LSTM    :\t"+str(recall_score(test_integer_labels, predicted_labels)))
